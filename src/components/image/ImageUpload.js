    ...
    >
      ...
      {image && (
        <Fragment>
          ...
          <button
            type="button"
            className="w-16 h-16 bg-white rounded-full flex items-center justify-center cursor-pointer absolute z-10 text-red-500 invisible opacity-0 transition-all group-hover:visible group-hover:opacity-100"
